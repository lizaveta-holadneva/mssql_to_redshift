...
class DatabaseRequest:
    ...
    def create_table(self):
        ...
        self.cur2.execute("CREATE TABLE IF NOT EXISTS curingdata_values (id varchar(256), valueid integer encode az64, timestamp timestamp encode az64,realvalue double precision,hist_id BIGINT IDENTITY NOT NULL);")
        self.conn2.commit()
